...
public class CraftingUIScroll : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.UpArrow))
        {
            ...
            float selectedPositionY = Mathf.Abs(selectedRectTransform.parent.parent.GetComponent<RectTransform>().anchoredPosition.y) + selectedRectTransform.rect.height;
            if (selectedRectTransform.name == "CraftButton")
            {
                selectedPositionY = Mathf.Abs(selectedRectTransform.parent.GetComponent<RectTransform>().anchoredPosition.y) + selectedRectTransform.rect.height;
            }
